...
.sheet-photo { height: 210rpx; margin-bottom: 14rpx; flex: none; overflow: hidden; display: grid; place-items: center; border-radius: 16rpx; color: white; background: var(--v19-brand-800); font-size: 30rpx; }
...
.sheet-body { display: -webkit-box; overflow: hidden; white-space: pre-line; -webkit-box-orient: vertical; -webkit-line-clamp: 3; }
