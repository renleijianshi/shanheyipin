...
export const V19_STOREFRONT_PREVIEW: readonly StorefrontProductSummary[] = [
  {
    id: 'preview-persimmon-share', categoryCode: 'seasonal', name: '舟曲吊柿 · 分享装', subtitle: '应季甄选 · 甘肃舟曲',
  ...
  {
    id: 'preview-persimmon-gift', categoryCode: 'gift', name: '吊柿 · 臻选礼盒', subtitle: '礼盒 · 节日赠礼',
  ...
  {
    id: 'preview-yunnan-coffee', categoryCode: 'mountain', name: '云南精品咖啡豆', subtitle: '山野好物 · 云南',
  ...
  {
    id: 'preview-grassland-beef', categoryCode: 'mountain', name: '草原风味牛肉干', subtitle: '山野好物 · 草原风物',
